<template>
    <section class="bg-white dark:bg-gray-900 hero">
        <div class="flex items-center justify-center content-center h-full">
            <div class="w-9/12 place-self-center">
                <div class="p-8 rounded-lg w-fit h-full bg-white dark:bg-gray-900 drop-shadow-lg">
                    <h1
                        class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
                        Chess & JavaScript</h1>
                    <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        ChessJS is a chess website like no other. Through the creation of variants, Chess now has a
                        nearly
                        unlimited possibilities on how it's played, all make possible through a simple API using
                        JavaScript.
                    </p>

    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                <h1 class="text-gray-900 dark:text-white">Privacy Policy</h1>

                <p>At DeepCore, accessible from https://deepcore.dev/, one of our main priorities is the privacy of our
                    visitors. This Privacy Policy document contains types of information that is collected and recorded
                    by DeepCore and how we use it.</p>

                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>

                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in DeepCore. This policy is not
                ...
                <h2 class="text-gray-900 dark:text-white">Consent</h2>

                <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

                <h2 class="text-gray-900 dark:text-white">Information we collect</h2>
                ...
                <h2 class="text-gray-900 dark:text-white">Log Files</h2>

                <p>DeepCore follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <h2 class="text-gray-900 dark:text-white">Cookies and Web Beacons</h2>

                <p>Like any other website, DeepCore uses 'cookies'. These cookies are used to store information
                ...
                <h2 class="text-gray-900 dark:text-white">Advertising Partners Privacy Policies</h2>
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on DeepCore, which are sent
                ...
                <p>Note that DeepCore has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2 class="text-gray-900 dark:text-white">Third Party Privacy Policies</h2>

                <p>DeepCore's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                ...
                <h2 class="text-gray-900 dark:text-white">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                ...
                <h2 class="text-gray-900 dark:text-white">GDPR Data Protection Rights</h2>
                ...
                <h2 class="text-gray-900 dark:text-white">Children's Information</h2>
                ...
                <p>DeepCore does not knowingly collect any Personal Identifiable Information from children under the age
